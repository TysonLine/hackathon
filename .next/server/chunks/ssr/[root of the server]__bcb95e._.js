...
const UploadResume = ()=>{
    ...
    const handleFileChange = (event)=>{
        if (event.target.files && event.target.files[0]) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$pdftotext$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(uploadedFile).then((text)=>{
                console.log(text);
                setText(text);
            }).catch((error)=>{
